...
export const NAV_ITEMS = [
  ...
  {
    label: "CRM populaires",
    href: "#",
    children: [
      { label: "HubSpot CRM", href: "/crm/hubspot-crm" },
      { label: "Salesforce", href: "/crm/salesforce" },
      { label: "Pipedrive", href: "/crm/pipedrive" },
      { label: "Sellsy", href: "/crm/sellsy" },
      { label: "Zoho CRM", href: "/crm/zoho-crm" },
      { label: "Axonaut", href: "/crm/axonaut" },
    ],
  },
];
